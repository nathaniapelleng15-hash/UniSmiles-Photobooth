-- Schema untuk Aiven Cloud MySQL (database: defaultdb)
-- Jalankan sekali untuk inisialisasi tabel
...
-- 3. Tabel untuk menyimpan hasil foto
...
-- 4. Tabel untuk menyimpan log gesture tangan
...
-- 5. Tabel untuk menyimpan daftar filter gambar
...
-- 6. Tabel relasi many-to-many foto dengan filter
...
-- 7. Tabel untuk menyimpan transaksi pembayaran
...
SELECT 'Schema Aiven berhasil dibuat!' AS status;
